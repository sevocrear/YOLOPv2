...
if __name__=='__main__':
    ...
    parser.add_argument("--model_path", type=str, default='onnx/yolopv2_192x320.onnx', help="model path")
    parser.add_argument('--source', type=str, default='data/demo/fs2.jpg', help='source') 
